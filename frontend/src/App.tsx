...
const CONTRACT_ADDRESS = "0xb90894A6E43093aD737231243D2e6121160CbD15"; // Hardcoded to override old Vercel dashboard environment variables
          ...
          <div className="p-10 max-w-6xl w-full mx-auto flex-1 pb-16">
            ...
            {activeTab === 'dashboard' && (
              <div className="animate-in fade-in duration-500">
                ...
                {/* Stats Grid */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 pt-8 border-t border-[#222]">
